document.addEventListener('DOMContentLoaded', () => {
    ...
    const individualProjects = [
        ...
        { id: 'p1a', client: 'School Assignment', year: 'Spring 2025', role: 'Student', categoryId: 'proj-1', thumbnail: '001/desmos_thumbnail.png', projectImages: ['001/Desmos.gif', '001/desmos-demo.gif', '001/desmos-flow.png'],
          title: 'Desmos Mobile App UI/UX Redesign', overview: 'Redesign concept for the Desmos mobile app that help create a more accessible, easier to use, and a more powerful tool to help enhance the aim of the company to ensure that everyone has the opportunity to discover their inner mathematician.', outcome: 'This project helped me focus on the process of designing a product over the final visual designs. I learned to define a clear solution to a specific problem statement, and I went through ideating, prototyping, usability testing, iterating, and thinking about presentation of the product. Disclaimer: Unaffiliated or endorsed by any agencies depected. This is a fan made concept and any logos used are for non-commercial, visual use only. All trademarks and agency names belong to their respective owners.', images: 3 },
        { id: 'p1b', client: 'School Assignment', year: 'Fall 2025', role: 'Student', categoryId: 'proj-1', thumbnail: '001/redesign_process.png', projectImages: ['001/library_app.png', '001/library-menu.png', '001/library-wallet.png'],
        ...
        { id: 'p1c', client: 'School Assignment', year: 'Fall 2025', role: 'Student', categoryId: 'proj-1', thumbnail: '001/ai_tech_app.png', projectImages: ['001/compare_AI.png', '001/compare-1.png', '001/compare-2.png'],
        ...
        { id: 'p2a', client: 'Creative Agency XYZ', year: '2024', role: 'Product Designer & Developer', categoryId: 'proj-2', thumbnail: 'desmos_thumbnail.png', projectImages: ['desmos_1.png', 'desmos_2.png', 'desmos_3.png'],
          title: 'Project 4', overview: 'Developed an AI-assisted design tool that helps designers generate layout variations and color palettes based on pre-defined brand guidelines.', outcome: 'Reduced design iteration time by 50% for the creative team.', images: 3 },
        { id: 'p2b', client: 'Furniture Retailer', year: '2024', role: 'AR Developer', categoryId: 'proj-2', thumbnail: 'desmos_thumbnail.png', projectImages: ['desmos_1.png', 'desmos_2.png', 'desmos_3.png'],
          title: 'Project 5', overview: 'Built AR features allowing customers to visualize furniture in their homes using their mobile camera, integrated with the e-commerce platform.', outcome: 'Increased online sales by 60% with reduced return rates.', images: 3 },
        ...
        { id: 'p4a', client: 'School Assignment', year: 'Spring 2025', role: 'Student', categoryId: 'proj-4', thumbnail: '004/speciesism-1.png', projectImages: ['004/speciesism-2.png', '004/speciesism-3.png', '004/speciesism-4.png'],
