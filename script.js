document.addEventListener('DOMContentLoaded', () => {
    ...
    const individualProjects = [
        ...
        { id: 'p4c', client: 'SVA Orientation', year: '2025-2026', role: 'Student', categoryId: 'proj-4', thumbnail: '004/OL-design.jpg',
          title: 'SVA Orientation Leaders T-Shirt Designs', overview: 'Designed T-Shirt for OLs during SVA Welcome Week. Also worked as an OL for five semesters welcoming new incoming students.', outcome: 'Sent over 50 emails to new students giving advice and sharing key information.', images: 3 },
